...
<template>
  <div class="page-grid">
    <el-card class="panel-card"><div class="card-header-line"><div><h2>药品库存与处方笺</h2><p>集中查看药品库存、处方开具和药品出入库情况，处方生效后同步扣减库存。</p></div><div class="action-inline"><el-button @click="store.refresh()">刷新</el-button><el-button @click="openStock">药品入库</el-button><el-button type="success" @click="openPrescription">新增处方</el-button></div></div><div class="action-inline"><el-input v-model="keyword" placeholder="按药品、批号、处方编号筛选" clearable /><el-button>导出</el-button></div></el-card>

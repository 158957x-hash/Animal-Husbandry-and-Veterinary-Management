...
export function createSeedData(): AppData {
  return {
    ...
    threeCertificateLinks: [
      ...
      { id: 'link-001', waitingBatchId: 'batch-001', animalCertificateId: 'cert-seed-issued', productCertificateId: 'product-cert-001', meatQualityCertificateId: 'meat-cert-001', linkedAt: '2026-06-13T14:00:00.000Z' },
    ],
    ...
    slaughterBatches: [
      ...
      {
        id: 'batch-002',
        batchNo: 'DZPC202606130002',
        entryRecordId: 'entry-abnormal-asf',
        quarantineCertificateId: 'cert-abnormal-asf',
        animalType: '生猪',
        entryQuantity: 40,
        waitingQuantity: 40,
        slaughterQuantity: 0,
        qualifiedCarcassQuantity: 0,
        unqualifiedQuantity: 0,
        earTagRange: 'AH-LF-2026-2001~AH-LF-2026-2040',
        waitingPenNo: '待宰圈B-01',
        status: 'self_check_failed',
        createdAt: '2026-06-13T10:00:00.000Z',
      },
      {
        id: 'batch-003',
        batchNo: 'DZPC202606130003',
        entryRecordId: 'entry-abnormal-drug',
        quarantineCertificateId: 'cert-abnormal-drug',
        animalType: '生猪',
        entryQuantity: 38,
        waitingQuantity: 38,
        slaughterQuantity: 0,
        qualifiedCarcassQuantity: 0,
        unqualifiedQuantity: 0,
        earTagRange: 'AH-LF-2026-3001~AH-LF-2026-3038',
        waitingPenNo: '待宰圈C-02',
        status: 'self_check_failed',
    ...
    slaughterSelfInspections: [
      ...
      },
      {
        id: 'selfcheck-002',
        batchId: 'batch-002',
        africanSwineFeverResult: 'positive',
        africanSwineFeverTestPerson: '张检验',
        africanSwineFeverTestTime: '2026-06-13T10:30:00.000Z',
        bannedDrugResult: 'negative',
        bannedDrugTestPerson: '李检验',
        bannedDrugTestTime: '2026-06-13T10:45:00.000Z',
        status: 'failed',
      ...
      },
      {
        ...
        africanSwineFeverResult: 'negative',
        africanSwineFeverTestPerson: '张检验',
        africanSwineFeverTestTime: '2026-06-13T11:00:00.000Z',
        bannedDrugResult: 'positive',
        bannedDrugTestPerson: '李检验',
        bannedDrugTestTime: '2026-06-13T11:15:00.000Z',
        status: 'failed',
